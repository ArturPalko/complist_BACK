...
namespace complist_BACK.Migrations
{
    ...
    [Migration("20260831110728_AddUniqueDictionaryIndexes")]
    partial class AddUniqueDictionaryIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MailSection", b =>
                {
                    b.HasOne("complist_BACK.Entities.Mail", null)
                        .WithMany()
                        .HasForeignKey("MailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("complist_BACK.Entities.Section", null)
                        .WithMany()
            ...
            modelBuilder.Entity("complist_BACK.Entities.ResponsibleUser", b =>
                {
                    b.HasOne("complist_BACK.Entities.Mail", "Mail")
